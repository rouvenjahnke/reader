...
export function RatingActionBar({ currentStatus, disabled, onRate }: Props): React.ReactElement {
  return (
    <div className="reader-safe-bottom fixed inset-x-0 bottom-0 z-30 border-t border-neutral-200 bg-white/95 px-3 pt-3 backdrop-blur dark:border-neutral-800 dark:bg-neutral-950/95">
